...
private slots:
    ...
    void on_pushButton_transpose_3_clicked();

    void on_pushButton_det_3_clicked();

    void on_pushButton_inver_3_clicked();

    void on_pushButton_scalarmul_5_clicked();
